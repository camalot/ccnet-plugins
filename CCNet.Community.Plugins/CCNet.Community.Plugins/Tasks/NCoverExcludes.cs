...
namespace CCNet.Community.Plugins.Tasks {
  [ReflectorType("excludes")]
  public class NCoverExcludes {
    public NCoverExcludes ( ) {
      this.Attributes = new string[ 0 ];
      this.Files = new string[ 0 ];
      this.Types = new string[ 0 ];
      this.Methods = new string[ 0 ];
      this.DisableAutoExclusion = false;
    }

    [ReflectorArray ( "attributes", Required = false )]
    public string[ ] Attributes { get; set; }
    [ReflectorArray ( "files", Required = false )]
    public string[ ] Files { get; set; }
    [ReflectorArray ( "types", Required = false )]
    public string[ ] Types { get; set; }
    [ReflectorArray ( "methods", Required = false )]
