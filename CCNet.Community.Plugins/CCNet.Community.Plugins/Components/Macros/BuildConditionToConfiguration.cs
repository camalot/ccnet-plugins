...
namespace CCNet.Community.Plugins.Components.Macros {
  ...
  /// <summary>
  /// Converts the Build Condition to a Configuration. Either Release or Debug.
  /// </summary>
  /// <example>
  /// <c>@{BuildConditionToConfiguration()}</c>
  /// </example>
  public class BuildConditionToConfiguration : IMacro{
