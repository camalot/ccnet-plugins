...
namespace CCNet.Community.Plugins.Components.Macros {
  /// <summary>
  /// Returns the size of a file. The argument is a path that can be an absolute path or relative to the 
  /// ArtifactDirectory.
  /// </summary>
  /// <example>
  /// <c>@{GetFileSize(Path\To\File)}</c>
  /// </example>
  public class GetFileSize : IMacro {
