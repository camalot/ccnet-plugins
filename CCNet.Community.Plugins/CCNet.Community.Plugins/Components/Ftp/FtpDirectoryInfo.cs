...
namespace CCNet.Community.Plugins.Components.Ftp {
  ...
  /// 
  /// </summary>
  public class FtpDirectoryInfo : FtpSystemInfo {
    /// <summary>
    /// Initializes a new instance of the <see cref="FtpDirectoryInfo"/> class.
    /// </summary>
    /// <param name="name">The name.</param>
    public FtpDirectoryInfo ( string name )
    ...
    internal FtpDirectoryInfo ( string name, long size, FtpSystemInfoPermission owner,
      FtpSystemInfoPermission group, FtpSystemInfoPermission publicUsers, DateTime lastModified )
      : base ( name, size, owner, group, publicUsers, true, lastModified ) {
